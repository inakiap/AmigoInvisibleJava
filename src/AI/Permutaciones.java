...
// Hacer combinacion con 1º emisor y un receptor al azar
...
//			System.out.println("Receptor: " + auxNombre);
			...
			//si el emisor y el recepetor son distintos se busca si el participante lo tiene en su lista de exclusiones
			if (!participantes[i].nombre.equals(auxNombre)) {
				
				/*se recorre la lista de exclusiones para encontrar si el posible
			  	receptor se encuentra en ella, si no lo está se encontró una combinación válida*/			
